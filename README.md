# THIS IS A FORK OF SIDUCK's CHADWM, I already have forked his in the event that there is an issue that I need to fix with chadwm, but this will hold my own personal configs and changes here
...
*KNOWN ISSUE WITH SDDM WITH THIS WAY OF INSTALLING, MAKE SURE TO CHANGE THE EXEC LINE TO HAVE JUST DWM ON IT*

```
[Desktop Entry]
Name=chadwm
Comment=dwm made beautiful 
Exec= ~/.config/chadwm/scripts/./run.sh # change this to Exec=dwm
Type=Application 
```
